...
const locale = {
  ...
  'indicatorIde.oosBanner': 'OOS validation enabled. Train: {trainStart} → {trainEnd}. Holdout: {oosStart} → {oosEnd}. Candidate metrics shown below are from the training window; OOS score / degradation are from the holdout window.',
  ...
  'polymarket.analysis.multipleMatched': 'Multiple markets matched',
  'polymarket.analysis.multipleMatchedTip': 'Pick the exact market below, or paste the precise Polymarket URL to avoid analyzing the wrong market.',
  'polymarket.analysis.useThisMarket': 'Analyze this market',
  'polymarket.analysis.marketNotFound': 'Market not found. Please double-check the URL or title.',
  'polymarket.analysis.urlNotParseable': 'Could not parse a market from this Polymarket URL. Please copy the full URL directly from the market page.',

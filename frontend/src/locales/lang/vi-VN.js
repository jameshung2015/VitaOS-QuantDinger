...
'indicatorIde.editor.fastLessThanSlow': 'Fast line parameter must be less than slow line parameter',
  ...
  'polymarket.analysis.multipleMatched': 'Khớp với nhiều thị trường',
  'polymarket.analysis.multipleMatchedTip': 'Vui lòng chọn thị trường cần phân tích bên dưới, hoặc dán liên kết Polymarket chính xác để tránh phân tích nhầm thị trường.',
  'polymarket.analysis.useThisMarket': 'Phân tích thị trường này',
  'polymarket.analysis.marketNotFound': 'Không tìm thấy thị trường. Vui lòng kiểm tra lại liên kết hoặc tiêu đề.',
  'polymarket.analysis.urlNotParseable': 'Không thể xác định thị trường từ liên kết Polymarket này. Vui lòng sao chép URL đầy đủ trực tiếp từ trang thị trường.',

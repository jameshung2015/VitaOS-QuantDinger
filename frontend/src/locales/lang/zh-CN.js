...
const locale = {
  ...
  'indicatorIde.oosBanner': '已启用 OOS 验证：训练区间 {trainStart} ~ {trainEnd}，验证区间 {oosStart} ~ {oosEnd}。下方候选展示的指标基于训练区间，OOS 分/退化基于验证区间。',
  ...
  'polymarket.analysis.multipleMatched': '匹配到多个可能的市场',
  'polymarket.analysis.multipleMatchedTip': '请从下方选择您要分析的市场，或粘贴更精确的 Polymarket 市场链接以避免分析错误的市场。',
  'polymarket.analysis.useThisMarket': '分析此市场',
  'polymarket.analysis.marketNotFound': '未找到对应的市场，请核对链接或标题是否正确。',
  'polymarket.analysis.urlNotParseable': '无法从此 Polymarket 链接中解析市场标识，请直接从市场页复制完整链接。',

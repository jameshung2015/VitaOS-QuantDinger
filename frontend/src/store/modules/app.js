...
const SUPPORTED_LANGS = ['en-US', 'zh-CN']
const normalizeLang = (lang) => (SUPPORTED_LANGS.includes(lang) ? lang : 'en-US')
  ...
  actions: {
    setLang ({ commit }, lang) {
      return new Promise((resolve, reject) => {
        ...
        commit(APP_LANGUAGE, safeLang)
        loadLanguageAsync(safeLang).then(() => {
          resolve()
        }).catch((e) => {
          reject(e)
        })
